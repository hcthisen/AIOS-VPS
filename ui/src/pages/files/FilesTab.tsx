  ...
  if (!cfg?.configured) {
    return (
      <Section
        ...
        description="Point this department at an S3-compatible bucket. Credentials save to .env; a ‘File storage’ section is appended to CLAUDE.md so the agent knows how to use it."
      >
        <StorageSetup
          deptName={deptName}
